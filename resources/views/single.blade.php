...
<body>
	@include('header')
		...
		<div class="banner1">
			<div class="container">
				<h3><a href="index">Home</a> / <span>Single</span></h3>
			</div>
		</div>
	<!--banner-->
								...
								<div class="col-md-4 product-grid">
									<div id="owl-demo" class="owl-carousel">
										...
										<div class="item">
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single"><img class="img-responsive " src="images/r4.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single">Lorem ipsum dolor </a></h6>
													<div class="block">
											...
											<div class="recent-grids">
												<div class="recent-left">
													<a href="single"><img class="img-responsive " src="images/r5.jpg" alt=""></a>	
												</div>
												<div class="recent-right">
													<h6 class="best2"><a href="single">Duis aute irure </a></h6>
													<div class="block">
